...
namespace SEIDR
{
    ...
    public class DateFormatter
    {
        ...
        public DateFormatter(params string[] names)
        {
        ...
        {
            DateFormatter d = new DateFormatter(1);
        ...
        /// <returns></returns>
        public static bool ParseOnceS(string value, out DateTime result)
        {
            DateFormatter d = new DateFormatter(1);
            d.checkSanity = true;
            return d.ParseString(0, value, out result);
