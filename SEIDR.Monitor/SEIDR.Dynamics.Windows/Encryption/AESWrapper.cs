...
namespace SEIDR.Dynamics.Configurations.Encryption
{
    /// <summary>
    /// See stackoverflow.com/questions/10168240/encrypting-decrypting-a-string-in-c-sharp. Code source for wrapper.
    /// <para>Mainly meant to keep file content from being manually edited or managed...</para>
    /// </summary>
    public static class AESWrapper
    {
        ...
        /// classes and methods out of System.Security.Cryptography. It's really just for making non plain text so users can't easily edit data.
        /// </summary>
