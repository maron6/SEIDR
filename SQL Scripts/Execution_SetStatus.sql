USE MIMIR
GO
ALTER PROCEDURE SEIDR.usp_JobExecution_StartWork
...
END
GO
ALTER PROCEDURE SEIDR.usp_JobExecution_SetStatus
	@JobExecutionID bigint,
	@JobProfileID int,
...
BEGIN	
	...
	BEGIN
		...
		if NOT EXISTS(SELECT null 
					...
					AND IsComplete = 0 AND IsError = 0)
		BEGIN
			RETURN 0
		END
	...
	BEGIN
		...
		SET FilePath = @FilePath,
			...
			FileHash = @FileHash,
			IsWorking = 0,
			InWorkQueue = CASE WHEN @CanRetry = 1 then 1
